/**
 * filepath: apps/your-dedicated-marketer/components/Footer.tsx
 * purpose: Render the site footer with navigation and social links.
    ...
    <footer className="bg-foreground text-background/80">
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Brand Column */}
          <div>
            <h3 className="text-2xl font-bold text-background mb-4">YD Marketer</h3>
