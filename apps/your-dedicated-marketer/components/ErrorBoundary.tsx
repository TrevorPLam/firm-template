...
/**
 * filepath: apps/your-dedicated-marketer/components/ErrorBoundary.tsx
 * purpose: Render a branded error fallback with safe recovery actions.
          ...
          <div className="max-w-md w-full bg-background rounded-lg shadow-lg p-8 text-center">
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full px-6 py-3 bg-primary text-primary-foreground font-semibold rounded-lg hover:bg-primary-hover transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary disabled:cursor-not-allowed disabled:bg-primary/70"
              >
                Try again
              </button>
              <button
                ...
                className="w-full px-6 py-3 bg-background text-foreground font-semibold rounded-lg border border-border hover:bg-background-alt transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
              >
                Go to homepage
              </button>
            </div>
