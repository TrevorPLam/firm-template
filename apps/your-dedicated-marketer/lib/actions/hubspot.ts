...
/**
 * HubSpot-related functions for contact form actions.
 *
 * @module lib/actions/hubspot
 */
...
export async function searchHubSpotContactId(email: string, emailHash: string): Promise<string | undefined> {
