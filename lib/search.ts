...
const staticPages: SearchItem[] = [
  {
    id: 'page-home',
    title: 'Home',
    description: 'Overview of our professional services, results, and client success stories.',
    href: '/',
    type: 'Page',
    tags: ['services', 'professional', 'firm'],
  },
  {
    id: 'page-services',
    title: 'Services',
  ...
  },
  {
    id: 'page-pricing',
    title: 'Pricing',
    description: 'Review service packages, deliverables, and pricing tiers.',
    href: '/pricing',
    type: 'Page',
  ...
  },
  {
    id: 'page-blog',
    title: 'Blog',
    description: 'Industry insights, trends, and strategies from our team.',
    href: '/blog',
    type: 'Page',
    tags: ['blog', 'insights'],
  },
  ...
  },
  {
    id: 'page-about',
    title: 'About',
    description: 'Learn about the team, mission, and approach.',
    href: '/about',
    type: 'Page',
    tags: ['team', 'mission'],
  },
